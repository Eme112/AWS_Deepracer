...
In this version:
* Smaller Heading Thresholds (to try to avoid the car going to the sides of the track)
'''

import math

# Constants
HEADING_THRESHOLD_1 = 5.0
HEADING_THRESHOLD_2 = 10.0
HEADING_THRESHOLD_3 = 15.0
