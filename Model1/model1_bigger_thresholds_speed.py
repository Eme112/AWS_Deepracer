...
In this version:
* Bigger Heading Thresholds, and now it is an exponential function.
* Speed Reward (to try to make the car go faster)
'''
...
def reward_function(params):
    ...
    heading_reward = 3.5 * math.exp(-0.2 * heading_diff)
