...
In this version:
* Bigger Heading Thresholds (to try to avoid the car going to the sides of the track)
'''

import math

# Constants
HEADING_THRESHOLD_1 = 15.0
HEADING_THRESHOLD_2 = 30.0
HEADING_THRESHOLD_3 = 45.0
